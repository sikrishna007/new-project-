...
export const useSections = () => {
  ...
  // <RoleBasedGuard permissions={["ADMIN","VENDOR","VENDOR MANAGER","SALES MANAGER","EVENT MANAGER","MARKETING","ACCOUNTANT"]} >
  ...
  return useMemo(() => {
    ...
    switch (role){
      ...
      case 'VENDOR MANAGER':
        return [
          {
            subheader: "Vendor Manager Panel",
            items: [
              {
                title: t(tokens.nav.dashboard),
                path: paths.dashboard.index,
      ...
      case 'CUSTOMER SUPPORT':
        return [
          {
            subheader: "Customer Support Panel",
            items: [
              {
                title: t(tokens.nav.dashboard),
                path: paths.dashboard.index,
