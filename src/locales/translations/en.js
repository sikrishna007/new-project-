...
export const en = {
  ...
  [tokens.nav.countries]: 'Countries',
  [tokens.nav.states]: 'States',
  [tokens.nav.cities]: 'Cities',
  [tokens.nav.productManagement]: 'Product Management',
  [tokens.nav.category]: 'Category',
  [tokens.nav.subCategory]: 'Sub Category',
  [tokens.nav.products]: 'Products',
  [tokens.nav.userManagement]: 'User Management',
  [tokens.nav.employees]: "Employees",
  [tokens.nav.customers]: "Customers",
  [tokens.nav.vendors]: "Vendors",
  [tokens.nav.eventCategory]: "Event Category",
  [tokens.nav.kycVerification]: "KYC Verification",
  [tokens.nav.vendor]:"Vendors",
  [tokens.nav.businessCustomer]:"Business Customers",
  [tokens.nav.setup]: "Setup",
  [tokens.nav.hsn]: "HSN Code",
  [tokens.nav.sac]: "SAC Code",
  [tokens.nav.vendor]:"Vendors",
  [tokens.nav.businessCustomer]:"Business Customers"
};
